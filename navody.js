  ...
  ulohy: [
    {
      ...
      kroky: [
        ...
        { text: "Vyberte <b>Spôsob výdavkov</b> — skutočné alebo paušálne.", tlacidlo: "Spôsob výdavkov", snimka: "priznanieB-vyplnit-2",
          tip: "Príjmy, výdavky aj zaplatené odvody appka doplní z evidencie. Ručne sa píšu len príjmy mimo živnosti — zo zamestnania, z prenájmu a podobne. Spôsob výdavkov platí pre vybraný rok a je to ten istý výber ako v nastaveniach." },
        ...
        { text: "V kroku <b>4. Zhrnutie</b> doplňte <b>Údaje o daňovníkovi</b> a prejdite <b>Kontroly priznania</b>.", tlacidlo: "Kontroly priznania", snimka: "priznanieB-vyplnit-4" },
      ...
      podrobnosti: [
        ...
        { nadpis: "Osobné údaje v súbore",
          html: "<p>Meno, priezvisko a kód SK NACE s hlavnou činnosťou vyplníte v kroku <b>4. Zhrnutie</b> v časti <b>Údaje o daňovníkovi</b>. Kód SK NACE a činnosť sa zapisujú na každý rok zvlášť. DIČ appka berie z nastavení firmy.</p><p>Dátum narodenia appka nepýta. Riadok 02 vypĺňa len daňovník, ktorý nemá DIČ ani rodné číslo.</p>" },
  ...
  ulohy: [
    ...
    },
    {
      ...
      kroky: [
        ...
        { text: "Prvý raz appka vysvetlí, ako meranie funguje. Ťuknite na <b>Spustiť meranie</b> a prehliadaču povoľte polohu.", tlacidlo: "Meranie jazdy", snimka: "jazdy-merat-2" },
    ...
    },
    {
      ...
      kroky: [
        ...
        { text: "Ťuknite na <b>↳ Doplniť účel z výkazu</b> — jazdy dostanú účel podľa toho, čo ste v ten deň robili.", tlacidlo: "Doplniť účel z výkazu", snimka: "jazdy-sprievodca-3",
          tip: "Doplní sa len prázdny alebo predvolený účel — ten, ktorý ste napísali sami, ostane. Pôvodný účel sa uchová. Nesedí vám nový? V Knihe jázd ho pre zobrazený mesiac vrátite tlačidlom <b>↩ Vrátiť pôvodné</b>." },
